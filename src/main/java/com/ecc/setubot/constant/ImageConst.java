...
public class ImageConst extends ConstantCommon {
    // 默认的文件储存路径
    ...
    // 色图路径
    public static final String SETU_PATH = "." + File.separator + "pic" + File.separator + "setu";
    // 更改像素后的暂存路径
    public static final String TMP_SETU_PATH = "." + File.separator + "data" + File.separator + "images" + File.separator + "tmp";

    // 经过处理的图片前缀
    public static final String IMAGE_SCALE_PREFIX = "scale_";
    // 需要处理的大小阈值(mb)
    public static final double IMAGE_SCALE_MIN_SIZE = 4;
    // 需要处理的宽度尺寸阈值(像素)
    public static final double IMAGE_SCALE_MIN_HEIGHT = 3500;
    // 需要处理的长度尺寸阈值(像素)
    public static final double IMAGE_SCALE_MIN_WIDTH = 3500;
    ...
    public static final String NETWORK_IMAGE_URL_IS_EMPTY = "网络图片链接为空";
    ...
    public static final String SAUCENAO_API_TIMEOUT_FAIL = "Saucenao Api 请求超时";
    public static final String SAUCENAO_API_SEARCH_FAIL = "Saucenao Api请求失败";
    public static final String SAUCENAO_API_REQUEST_ERROR = "Saucenao Api请求异常 (Remote host terminated the handshake)";
